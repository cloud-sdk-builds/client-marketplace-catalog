...
[`@aws-sdk/client-marketplace-catalog`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-catalog/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-catalog@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6YYT80Jn1qmHLnTiepZ6vBauKOXQ0Pgsoh/EmxOlN3XwEoa8tzqefFDploBSnLE1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-catalog": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-catalog@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-catalog@3.772.0/index.min.mjs": "sha384-6YYT80Jn1qmHLnTiepZ6vBauKOXQ0Pgsoh/EmxOlN3XwEoa8tzqefFDploBSnLE1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-catalog/blob/refs/tags/3.772.0/LICENSE
```
